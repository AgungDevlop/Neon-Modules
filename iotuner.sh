#!/system/bin/sh
  ...
  echo -e "\033[1;32m"cmd notification post -S bigtext -t 'FPS INJECTOR' 'Tag' '💾 Starting I/O Tuning by © Agung Developer 2025' --icon "$ICON_URL"echo -e "\033[0m"
  ...
  cmd notification post -S bigtext -t 'FPS INJECTOR' 'Tag' '💾 I/O TUNED by © Agung Developer 2025' --icon "$ICON_URL"