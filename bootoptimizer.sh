#!/system/bin/sh
  ...
  echo -e "\033[1;32m"cmd notification post -S bigtext -t 'FPS INJECTOR' 'Tag' '🚀 Starting Boot Optimization by © Agung Developer 2025' --icon "$ICON_URL"echo -e "\033[0m"
  ...
  cmd notification post -S bigtext -t 'FPS INJECTOR' 'Tag' '🚀 BOOT ENHANCED by © Agung Developer 2025' --icon "$ICON_URL"